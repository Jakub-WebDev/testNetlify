...
export default function ProductsDetails() {
  ...
  function toggleColor(id, e) {
    setColor((color) => !color);
    handleFavouriteToggle(id, e);
  }
        ...
        {product ? (
          <div className={styles.details}>
            <div className={styles.littleImages}>
              <img src={headphones1} alt="headphones image" />
              <img src={headphones2} alt="headphones image" />
              <img src={headphones3} alt="headphones image" />
            </div>
            <img
              src={`/${product.image}`}
              alt={product.name}
            ...
            <div className={styles.detailsDetails}>
              ...
              <div className={styles.buttons}>
                ...
                <button
                  onClick={(e) => toggleColor(product.id, e)}
                  className={styles.smallButton}
                >
                  <svg
                    className={
                      product.favourite ? styles.redHeart : styles.blackHeart
                    }
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
          ...
          <div className={styles.details}>Product not found.</div>
        )}
      </div>
      <ProductDescription />
      <Related />
