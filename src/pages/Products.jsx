                ...
                <div key={rating} className={styles.ratingFilter}>
                  <label>
                    <input
                      ...
                      type="checkbox"
                      value={rating}
                      checked={state.selectedRatings.includes(rating)}
                      onChange={(e) => {
                        const isChecked = e.target.checked;
                        localDispatch({
                    ...
                    {[...Array(rating)].map((_, i) => (
                      ...
                      >
                        <g clipPath="url(#clip0_1591_5677)">
                          <path
                            d="M7.09749 1.89137C7.45972 1.13224 8.54028 1.13224 8.90251 1.89137L10.0704 4.33882C10.2162 4.64433 10.5066 4.85534 10.8422 4.89958L13.5308 5.25399C14.3647 5.36391 14.6986 6.39158 14.0885 6.97067L12.1218 8.83768C11.8763 9.07073 11.7653 9.41217 11.827 9.74502L12.3207 12.4115C12.4739 13.2386 11.5997 13.8737 10.8604 13.4725L8.47702 12.1789C8.1795 12.0174 7.8205 12.0174 7.52298 12.1789L5.13959 13.4725C4.40033 13.8737 3.52614 13.2386 3.67929 12.4115L4.17304 9.74502C4.23467 9.41217 4.12373 9.07073 3.87823 8.83768L1.91145 6.97067C1.30142 6.39158 1.63533 5.36391 2.46924 5.25399L5.15779 4.89958C5.4934 4.85534 5.78384 4.64433 5.92962 4.33882L7.09749 1.89137Z" // Add the path data for the star shape
                            fill="#F9BA00" // Yellow color
                          />
                        </g>
                        <defs>
